...
- 最大子串和
  ...
  - 补充，增加限制条件的最大字段和
    ...
    ![image-20201030200443850](/Users/lushixiang/CodingSpace/Git/Github.com/xiaoluxiang.github.io/images/ky/最大字段和-补充例题1.png)
...
- 0-1 背包
  ...
  - 0-1背包考虑的事情放与不放的问题，~~书上和网课思路不尽相同。书上是物品种类不变，从背包容量变化开始动态规划~~，网课大循环是物品种类增加，内循环是物品种类一致下，背包容量增加开始动态规划。
    ...
    - ![image-20201031115034152](/Users/lushixiang/CodingSpace/Git/Github.com/xiaoluxiang.github.io/images/ky/0-1背包文字描述.png)
